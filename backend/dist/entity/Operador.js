...
__decorate([
    ...
    __metadata("design:type", Object)
], Operador.prototype, "opPassword", void 0);
__decorate([
    (0, typeorm_1.Column)("character varying", { name: "op_verificate", length: 60 }),
    __metadata("design:type", String)
], Operador.prototype, "opVerificate", void 0);
__decorate([
    (0, typeorm_1.Column)("character varying", {
        name: "op_code_ath",
        nullable: true,
    ...
    __metadata("design:type", Object)
], Operador.prototype, "opCodeAth", void 0);
__decorate([
    (0, typeorm_1.Column)("date", { name: "op_time_to_exp", nullable: true }),
    __metadata("design:type", Object)
], Operador.prototype, "opTimeToExp", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => DocOp_1.DocOp, (docOp) => docOp.opCed2),
    __metadata("design:type", Array)
], Operador.prototype, "docOps", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Grupo_1.Grupo, (grupo) => grupo.opCed2),
    __metadata("design:type", Array)
], Operador.prototype, "grupos", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Mancuerna_1.Mancuerna, (mancuerna) => mancuerna.opCed2),
    __metadata("design:type", Array)
], Operador.prototype, "mancuernas", void 0);
exports.Operador = Operador = __decorate([
    (0, typeorm_1.Index)("operador_pk", ["opCed"], { unique: true }),
